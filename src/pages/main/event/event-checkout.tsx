      ...
      <div className="container mx-auto grid gap-6 p-4 md:grid-cols-[1fr,380px]">
        <div className="space-y-6">
          <div className="flex items-center gap-2">
            <h1 className="text-2xl font-semibold text-primary">Pagamento</h1>
          </div>
          ...
          {paymentMethod === 'pix' && <EventCheckoutPixForm />}
        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex justify-between">
                <div>
                  <span className="font-medium">1x</span> Mesa para 2 pessoas -
                  2° Lote
                </div>
              ...
              <div className="flex justify-between border-t pt-4">
                ...
                <span className="font-semibold">R$ 975,00</span>
              </div>
            </CardContent>
          </Card>
        </div>
